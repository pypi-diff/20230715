# Comparing `tmp/cdk8s-plus-24-2.8.90.tar.gz` & `tmp/cdk8s-plus-24-2.8.91.tar.gz`
...
## Comparing `cdk8s-plus-24-2.8.90.tar` & `cdk8s-plus-24-2.8.91.tar`
...
### Comparing `cdk8s-plus-24-2.8.90/LICENSE` & `cdk8s-plus-24-2.8.91/LICENSE`

 * *Files identical despite different names*

### Comparing `cdk8s-plus-24-2.8.90/PKG-INFO` & `cdk8s-plus-24-2.8.91/PKG-INFO`
...
### Comparing `cdk8s-plus-24-2.8.90/README.md` & `cdk8s-plus-24-2.8.91/README.md`

 * *Files identical despite different names*

### Comparing `cdk8s-plus-24-2.8.90/setup.py` & `cdk8s-plus-24-2.8.91/setup.py`
...
### Comparing `cdk8s-plus-24-2.8.90/src/cdk8s_plus_24/__init__.py` & `cdk8s-plus-24-2.8.91/src/cdk8s_plus_24/__init__.py`

 * *Files identical despite different names*

### Comparing `cdk8s-plus-24-2.8.90/src/cdk8s_plus_24/k8s/__init__.py` & `cdk8s-plus-24-2.8.91/src/cdk8s_plus_24/k8s/__init__.py`

 * *Files identical despite different names*

### Comparing `cdk8s-plus-24-2.8.90/src/cdk8s_plus_24.egg-info/PKG-INFO` & `cdk8s-plus-24-2.8.91/src/cdk8s_plus_24.egg-info/PKG-INFO`
